...
import { PROJECTS } from "../constants/index"; // Ensure PROJECTS is imported
    ...
    <section className="pt-20" id="projects">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
        {PROJECTS.map((project) => (
          <motion.div
          initial={{opacity:0,scale:0.9}} whileInView={{opacity:1,scale:1}} transition={{duration:0.5}} whileHover={{scale:1.05}}
            key={project.id}
